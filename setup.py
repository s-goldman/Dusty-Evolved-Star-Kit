...
PACKAGENAME = metadata.get('package_name', 'desk')
DESCRIPTION = metadata.get('description', 'Dusty Evolved Star Kit')
AUTHOR = metadata.get('author', 'Steven Goldman')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'https://github.com/s-goldman/Dusty-Evolved-Star-Kit')
__minimum_python_version__ = metadata.get("minimum_python_version", "2.7")

# Enforce Python version check - this is the same check as in __init__.py but
# this one has to happen before importing ah_bootstrap.
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: desk requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
...
VERSION = metadata.get('version', '1.0.2')
